<template>
      ...
      <el-col>
        <el-table
          :data="tableData"
          style="width: 100%">
          <el-table-column prop="place" label="申请住房地址" width="150"></el-table-column>
          ...
          <el-table-column prop="humanRelation" label="人事关系" width="150"></el-table-column>
          <el-table-column prop="group" label="组织结构" width="150"></el-table-column>
